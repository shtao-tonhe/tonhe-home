    ...
    <div class="top">
      <div class="contact">
          ...
          <div class="site-list">
            ...
            >
              <img
                ...
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/wechat.png"
                alt=""
              />
            </a>
            <a
              href="http://www.xiaohongshu.com"
              target="_blank"
              rel="noopener noreferrer"
              class="s-i"
            >
              <img
                ...
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/redbook.png"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                ...
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/bilibili.png"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/weibo2.png"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/zhihu2.png"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/QQ.png"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/mini.png"
                alt=""
              />
            </a>
            <a
            ...
            >
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/0.png"
                alt=""
              />
            </a>
            <div class="s-i">
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/insgram.png"
                alt=""
              />
            </div>
            <div class="s-i">
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/discord.png"
                alt=""
              />
            </div>
            <div class="s-i">
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/reddit.png"
                alt=""
              />
            </div>
            <div class="s-i">
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/youtube.png"
                alt=""
              />
            </div>
            <div class="s-i">
              <img
                style="width: 19px; height: 19px"
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/dy.png"
                alt=""
              />
            </div>
            <div class="s-i">
              <img
                ...
                src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/icons/email2.png"
                alt=""
              />
            </div>
          </div>
        ...
        <div class="email">
          ...
          <div class="enter">
            <input type="text" class="enter-input" />
            <div class="enter-btn">Sign up</div>
          </div>
        </div>
      </div>
      <div class="links">
        <div class="l-list">
          <div class="l-item">Resources</div>
          <div class="l-item">Code</div>
          <div class="l-item">DALL·E 3</div>
          <div class="l-item">Sora</div>
        </div>
        <div class="l-list">
          <div class="l-item">Community</div>
          <div class="l-item">ElementUI</div>
          <div class="l-item">AntD</div>
          <div class="l-item">Ether</div>
          <div class="l-item">Telegram</div>
        </div>
        <div class="l-list">
          <div class="l-item">More&nbsp;Products</div>
          <div class="l-item">ElementUI</div>
          <div class="l-item">AntD</div>
          <div class="l-item">Ether</div>
          <div class="l-item">Telegram</div>
        ...
        <div class="l-list">
          <div class="l-item">Learn</div>
          <div class="l-item">How to export?</div>
          <div class="l-item">What is an component?</div>
          <div class="l-item">What is an dataV?</div>
        </div>
      </div>
    </div>
    <div class="us">
      ...
      <a href="https://beian.mps.gov.cn/#/query/webSearch" target="_blank">
        <img
          src="https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/ba.png"
          alt=""
        />
        豫公网安备案36100002000386
      </a>
    </div>
  </div>
</template>
...
/* icomoon 字体图标库的示例 */
/* @font-face {
    font-family: "openAiSoe";
    src: url("https://eliauk.oss-cn-hangzhou.aliyuncs.com/tonhe/soehne-buch.6f91d491.woff2");
  } */
